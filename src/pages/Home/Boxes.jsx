          ...
          >
            <div className="w-[150%] h-[150%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
              ...
              >
                ...
                <div
                  className={`absolute w-[45px] lg:w-[55px] h-[45px] lg:h-[55px] transform transition-all duration-300 ${
                    box.bomb
                      ? "scale-100 z-10 opacity-100"
                      : "scale-0 z-0 opacity-0"
                  }`}
                >
                  {box.bomb && <div className="mines_container" />}
                  <svg
                    className={`w-[45px] lg:w-[55px] h-[45px] lg:h-[55px] transform transition-transform duration-300  ${
                      box.isBlue ? "scale-100" : "scale-0"
                    }`}
                ...
                <svg
                  className={`absolute w-[40px] lg:w-[50px] h-[40px] lg:h-[50px]  transform transition-all duration-300 ${
                    box.isBlue && !box?.bomb
                      ? "scale-100 z-10 opacity-100"
                      : "scale-0 z-0 opacity-0"
                  }`}
