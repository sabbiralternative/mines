          ...
          >
            <div className="w-[150%] h-[150%] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
              ...
              >
                ...
                <>
                  {box?.bomb ||
                    (box?.mine === 0 && <div className="mines_container" />)}
                  <svg
                    className={` transform transition-all duration-300  ${
                      box?.bomb || box?.mine === 0
                        ? "scale-100 z-50 w-[45px] lg:w-[55px] h-[45px] lg:h-[55px]"
                        : "scale-0 z-0 !h-0 !w-0"
                    }`}
                ...
                <svg
                  className={`   transform transition-all duration-300 ${
                    box.isBlue && !box?.bomb && box?.mine !== 0
                      ? "scale-100 z-50 w-[40px] lg:w-[50px] h-[40px] lg:h-[50px]"
                      : "scale-0 z-0 !w-0 !h-0"
                  }`}
                  xmlns="http://www.w3.org/2000/svg"
                  width={140}
